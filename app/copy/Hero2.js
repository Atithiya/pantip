...
export function Hero() {
  ...
  return (
    <div
      className="p-5 mt-20 container z-10 bg-slate-100 text-lg lg:text-sm"
      id="hero"
    >
      <div className="border border-solid border-zinc-300 rounded-lg ">
        ...
        {/* box */}
        <div className="p-5 rounded-b-lg grid grid-cols-2 md:grid-cols-4 lg:grid-cols-9 gap-4 text-slate-800">
          ...
          {roomInfo.map((room, index) => (
            ...
            >
              {/* Icon */}
              <div className="lg:text-2xl mb-2">{room.logo}</div>
              {/* Rooms' name */}
              <div>
                <p>{room.roomName}</p>
              </div>
